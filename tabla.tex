...
\begin{tabular}{|m{1.8cm}|m{1.5cm}|m{1.5cm}|m{9.5cm}|}
	...
	\hline
	add & boolean & Si & \textbf{False}(default): La tabla se limpia antes de insertar los valores de data. \textbf{True}: Los valores son agregados inmediatamente abajo de los existentes. \\
	\hline
\end{tabular}
\\\\\\
Ejemplo:
